...
var file_trading2_proto_rawDesc = []byte{
	...
	0x6f, 0x66, 0x66, 0x76, 0x61, 0x6c, 0x73, 0x22, 0x90, 0x02, 0x0a, 0x08, 0x53, 0x74, 0x72, 0x61,
	...
	0x74, 0x61, 0x6b, 0x65, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x74, 0x22, 0x78, 0x0a, 0x0c, 0x50, 0x4e,
...
var file_trading2_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_trading2_proto_goTypes = []interface{}{
	...
	(*Strategy)(nil),         // 7: tradingpb.Strategy
	(*PNLDataValue)(nil),     // 8: tradingpb.PNLDataValue
	(*PNLAssetData)(nil),     // 9: tradingpb.PNLAssetData
	(*PNLData)(nil),          // 10: tradingpb.PNLData
	(*SimTradingParams)(nil), // 11: tradingpb.SimTradingParams
	(*TradingNodeInfo)(nil),  // 12: tradingpb.TradingNodeInfo
}
var file_trading2_proto_depIdxs = []int32{
	...
	2,  // 10: tradingpb.PNLAssetData.asset:type_name -> tradingpb.Asset
	8,  // 11: tradingpb.PNLAssetData.values:type_name -> tradingpb.PNLDataValue
	3,  // 12: tradingpb.PNLAssetData.lstCtrl:type_name -> tradingpb.CtrlNode
	9,  // 13: tradingpb.PNLData.total:type_name -> tradingpb.PNLAssetData
	9,  // 14: tradingpb.PNLData.assets:type_name -> tradingpb.PNLAssetData
	2,  // 15: tradingpb.SimTradingParams.assets:type_name -> tradingpb.Asset
	2,  // 16: tradingpb.SimTradingParams.baselines:type_name -> tradingpb.Asset
	7,  // 17: tradingpb.SimTradingParams.strategies:type_name -> tradingpb.Strategy
	5,  // 18: tradingpb.SimTradingParams.wallet:type_name -> tradingpb.Wallet

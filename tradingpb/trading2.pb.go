...
type BuyParams struct {
	...
	InitMoney float32 `protobuf:"fixed32,1,opt,name=initMoney,proto3" json:"initMoney,omitempty"`
	PerMoney  float32 `protobuf:"fixed32,2,opt,name=perMoney,proto3" json:"perMoney,omitempty"`
...
var file_trading2_proto_rawDesc = []byte{
	...
	0x6f, 0x66, 0x66, 0x76, 0x61, 0x6c, 0x73, 0x22, 0x5d, 0x0a, 0x09, 0x42, 0x75, 0x79, 0x50, 0x61,
	...
	0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x22, 0x58, 0x0a, 0x0a, 0x53, 0x65, 0x6c, 0x6c, 0x50, 0x61,
	...
	0x28, 0x02, 0x52, 0x06, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x74, 0x22, 0x87, 0x04, 0x0a, 0x08, 0x53,
	...
	,
...
var file_trading2_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_trading2_proto_goTypes = []interface{}{
	...
	(*Strategy)(nil),         // 11: tradingpb.Strategy
	(*PNLDataValue)(nil),     // 12: tradingpb.PNLDataValue
	(*PNLAssetData)(nil),     // 13: tradingpb.PNLAssetData
	(*PNLData)(nil),          // 14: tradingpb.PNLData
	(*SimTradingParams)(nil), // 15: tradingpb.SimTradingParams
	(*TradingNodeInfo)(nil),  // 16: tradingpb.TradingNodeInfo
}
var file_trading2_proto_depIdxs = []int32{
	...
	2,  // 14: tradingpb.PNLAssetData.asset:type_name -> tradingpb.Asset
	12, // 15: tradingpb.PNLAssetData.values:type_name -> tradingpb.PNLDataValue
	3,  // 16: tradingpb.PNLAssetData.lstCtrl:type_name -> tradingpb.CtrlNode
	13, // 17: tradingpb.PNLData.total:type_name -> tradingpb.PNLAssetData
	13, // 18: tradingpb.PNLData.assets:type_name -> tradingpb.PNLAssetData
	2,  // 19: tradingpb.SimTradingParams.assets:type_name -> tradingpb.Asset
	2,  // 20: tradingpb.SimTradingParams.baselines:type_name -> tradingpb.Asset
	11, // 21: tradingpb.SimTradingParams.strategies:type_name -> tradingpb.Strategy
	5,  // 22: tradingpb.SimTradingParams.wallet:type_name -> tradingpb.Wallet
